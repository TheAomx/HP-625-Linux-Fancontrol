...
// configuration for linux kernel lower than 4.13
#if 0
...
// configuration for linux kernel higher than 4.13
#if 1
...
const std::array<ThermalArea, 4> thermal_areas = {{
        ...
        {.lower_bound = 50, .upper_bound = 60,  .devices = small_intensity_fans},
